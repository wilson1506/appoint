<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_partnersignup.aspx.cs" Inherits="staff" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <table class="style2">
                                ...
                                <tr>
                                    <td class="style18">
                                        Business Name</td>
                                    <td class="style4">
                                        <asp:TextBox ID="bizname" runat="server" Width="120px"></asp:TextBox>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                </tr>
